...
{
    public partial class TalkTo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Message_AspNetUsers_ByUserId",
                        column: x => x.ByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Message_AspNetUsers_ForUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Message_ByUserId",
                table: "Message",
                column: "ByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Message_ForUserId",
                table: "Message",
                column: "ForUserId");
        }
